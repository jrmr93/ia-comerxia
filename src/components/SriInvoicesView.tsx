                  ...
                  <td className="px-4 py-3 text-center">
                    {inv.estadoAutorizacion === 'AUTORIZADO' ? (
                      ...
                      <span className="px-2.5 py-1 rounded-full bg-sky-500/20 text-sky-300 text-[10px] font-bold border border-sky-400/30 inline-flex items-center gap-1">
                        <Sparkles className="w-3 h-3 text-sky-400" /> SIMULADO OK
                      </span>
                    ) : (
                      <span className="px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 text-[10px] font-bold border border-amber-400/30 inline-flex items-center gap-1">
                        <AlertCircle className="w-3 h-3 text-amber-400" /> {inv.estadoAutorizacion || 'PENDIENTE'}
                      </span>
                    )}
                  </td>
