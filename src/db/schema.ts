...
export const sriConfigs = pgTable('sri_configs', {
  ...
  estadoRuc: text('estado_ruc').default('ACTIVO'),
  ...
  lastFacturaSecuencial: integer('last_factura_secuencial').default(0),
  lastNotaCreditoSecuencial: integer('last_nota_credito_secuencial').default(0),
  lastNotaDebitoSecuencial: integer('last_nota_debito_secuencial').default(0),
  lastGuiaRemisionSecuencial: integer('last_guia_remision_secuencial').default(0),
  lastRetencionSecuencial: integer('last_retencion_secuencial').default(0),
  lastLiquidacionSecuencial: integer('last_liquidacion_secuencial').default(0),
  isActive: boolean('is_active').default(true),
  createdAt: timestamp('created_at').defaultNow(),
  updatedAt: timestamp('updated_at').defaultNow(),
});
